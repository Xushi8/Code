...
public:
    ...
    T range_sum(size_t l, size_t r) { return range_sum(l, r, 0, end, root); }

    void range_set(size_t l, size_t r, T val) { range_set(l, r, val, 0, end, root); }
};
...
int main()
{
    ...
    SegTreeLazyRangeSet<long long> segtree(arr);
    // segtree.range_set(0, 4, 10);
    ...
    while (tt--)
    {
        ...
        if (t == 1)
        {
            segtree.range_set(0, n - 1, a);
        }
        else if (t == 2)
        {
            int b;
            cin >> b;
            segtree.range_set(a - 1, a - 1, b + segtree.range_sum(a - 1, a - 1));
        }
        else
        {
            cout << segtree.range_sum(a - 1, a - 1) << '\n';
        }
    }
